...
export function MultilayerSimulator() {
  ...
  return (
    <section className="lab-card" id="multilayer-lab">
      <div className="lab-head"><div><span className="lab-tag">PHYSICS V2</span><h3>Polarization-aware multilayer simulator</h3></div><span className="evidence-pill academic">Characteristic-matrix learning model</span></div>
      <p className="muted">Explore thin-film interference with complex-index Snell propagation and separate s/p optical admittance. Default n/k values remain intentionally illustrative; production optical constants or coating recipes are not embedded.</p>
      ...
      <div className="formula-box"><code>M = ∏ Mᵢ · R = |r|² · ηs ≠ ηp</code><span>The model includes complex-index refraction and s/p admittance. It still omits interface roughness, interdiffusion, graded layers, measured wavelength dependence unless a cited dataset is loaded, and production-specific corrections.</span></div>
      <div className="lab-sources"><a href="https://arxiv.org/abs/1212.1258" target="_blank" rel="noreferrer">Periodic Mo/Si multilayer study ↗</a><a href="https://arxiv.org/abs/1912.09075" target="_blank" rel="noreferrer">Refined EUV mask model ↗</a><a href="/evidence/optical-constants.template.json" target="_blank" rel="noreferrer">Dataset template ↗</a></div>
    </section>
  )
}
