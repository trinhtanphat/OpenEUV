...
export function WaferStageLab() {
  ...
  return (
    <section className="lab-card stage-lab" id="stage-lab">
      ...
      <div className="stage-concepts"><article><strong>X · Y · Rz</strong><span>Conceptually relate to in-plane placement and overlay.</span></article><article><strong>Z · Rx · Ry</strong><span>Conceptually relate to focus, leveling and wafer-surface geometry.</span></article><article><strong>Scan synchronization</strong><span>Reticle and wafer motion must be coordinated during scanning; proprietary control implementation remains outside this model.</span></article><article><strong>Metrology feedback</strong><span>Measurements close the loop between desired coordinates and physical positioning at a system-concept level.</span></article></div>
    </section>
  )
}
